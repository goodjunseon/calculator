import sys
from PyQt5.QtWidgets import (QApplication, QWidget,QPushButton,QVBoxLayout,QMessageBox,QPlainTextEdit,QHBoxLayout) #QMessageBox : 메시지 박스 위젯
...
class Calculator(QWidget): #QWidget 클래스를 상속받아서 클래스를 정의
    ...
    def initUI(self):
        self.te1 = QPlainTextEdit() #텍스트 에디드 위젯 생성
...
if __name__=='__main__': #pyqt는 애플리케이션 당 1개의 QApplication이 필요함
    ...
    view = Calculator() #Calculator 인스턴스 생성
